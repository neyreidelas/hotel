...
namespace InovaTechSquadHotel.Classes
{
    internal class ConexaoSQL
    {
        ...
        private static readonly string _strConexao = @"Data Source = DESKTOP-S5EHQ7D\SQLEXPRESS; Initial Catalog = Hotel; Integrated Security = True";
        //private static string _strConexao = @"Data Source = VPR0684793W10-1\SQLEXPRESS; User ID=sa; Password=123456; Initial Catalog = Hotel;";
